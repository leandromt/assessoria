...
Route::group(['namespace' => 'Painel'], function () {
	...
	Route::get('/painel/alunos','PainelController@alunos');
	Route::get('/painel/aluno/{id?}','PainelController@aluno');
	Route::get('/painel/cadastro/aluno','PainelController@novoaluno');
	/* --- */
